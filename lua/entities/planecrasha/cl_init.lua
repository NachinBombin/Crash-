...
-- Verified working GMod particle textures
...
-- ─── Net receiver ──────────────────────────────────────────────────
-- Receives the bone-space world pos of the crash site, sampled at t=17.5
-- (2.5s into the boom animation) when the wreckage has visually settled.
-- All effects spawn here -- no more offsets from animated entity origin.
...
net.Receive( "PlaneCrashEffects", function()
    ...
    -- Secondary blasts timed to existing ScreenShake calls.
    -- Server shakes at ENT t=20.5,23,24,26. Net fires at t=17.5.
    -- Offsets: 20.5-17.5=3.0, 23-17.5=5.5, 24-17.5=6.5, 26-17.5=8.5
